...
class Lobby(models.Model):
    ...
    - active: a boolean indicating whether the the lobby is active
    """
...
class Session(models.Model):
    ...
    - lobby: a one-to=many relationship with Lobby
    - colour: the RGB colour assigned to the session
    """
    ...
    def save(self, *args, **kwargs):
        ...
        if self.colour == '' or self.colour is None:
            ...
            while colour in Session.objects.all().values_list('colour', flat=True):
                colour = get_colour()
...
class Territory(models.Model):
    ...
    - default_food: the amount of food produced by the territory
    - default_gold: the amount of gold produced by the territory
    - default_population: the size of the population held by the territory
    - default_army: the size of the army held by the territory
    - coordinates: the coordinates of the territory
